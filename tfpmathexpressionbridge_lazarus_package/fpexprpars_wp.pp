...
function IsNumber(AValue: Double): Boolean;
...
begin
  ...
  case Result.ResultType of
    ...
    rtFloat    : if IsNumber(Result.ResFloat) and IsNumber(RRes.ResFloat) then
...
begin
  ...
  case Result.ResultType of
    ...
    rtFloat    : if IsNumber(Result.ResFloat) and IsNumber(RRes.ResFloat) and
                   (RRes.ResFloat <> 0.0)
                 then
                   Result.ResFLoat:=Result.ResFLoat/RRes.ResFLoat
                 else
