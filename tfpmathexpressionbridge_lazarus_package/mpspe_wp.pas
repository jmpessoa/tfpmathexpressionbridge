...
begin
  ...
  then begin
    Result := NaN;
    exit;
//    raise ENumLib.CreateFmt(SPositiveArgumentRequired1, ['Bessel function K1']);
//    RunError(402);
  end;
  if x<=xsmall
  then
...
begin
  ...
  then begin
    Result := NaN;
    exit;
//    raise ENumLib.CreateFmt(SPositiveArgumentRequired1, ['Bessel function Y0']);
//    RunError(403);
  end;
  if x<=xvsmall
  then
...
begin
  ...
  then begin
    Result := NaN;
    exit;
    //raise ENumLib.CreateFmt(SPositiveArgumentRequired1, ['Bessel function Y1']);
    //RunError(404);
  end;
  if x<=xsmall
  then
